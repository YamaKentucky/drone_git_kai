...
ramda1  = 0.01#0.5#0.005
ramda3  = 0.01#0.5#0.005
ramda5  = 0.01#0.5#0.005
ramda7  = 0.01#0.5#0.005
ramda9  = 0.01#0.5#0.005
ramda11 = 0.01#0.5#0.005
...
#    print "{:+7.3f}".format(x_new[:,0][6]*180/np.pi),",","{:+7.3f}".format(x_new[:,0][7]*180/np.pi),",","{:+7.3f}".format(x_new[:,0][8]*180/np.pi),",","{:+7.3f}".format(pitch*180/np.pi)
    ...
    if throt > 10:
        ...
        print "{:+7.3f}".format(x_new[:,0][6]*180/np.pi),",","{:+7.3f}".format(gyro_low[0]),",","{:+7.3f}".format(tau_pitch)
