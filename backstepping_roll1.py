...
#    print "{:+7.3f}".format(x_new[:,0][6]*180/np.pi),",","{:+7.3f}".format(x_new[:,0][7]*180/np.pi),",","{:+7.3f}".format(x_new[:,0][8]*180/np.pi),",","{:+7.3f}".format(pitch*180/np.pi)
    ...
    if throt > 10:
        ...
        tau_roll = 1000 * 1000 * I_y * ((1+ramda9+c[8]*c[9])*(roll-x_new[:,0][7])+(c[8]+c[9])*(-omega2)+c[9]*ramda9*e_9-a_2*omega1*omega3)+1000*1000*0.04*0.13*9.81*np.sin(x_new[:,0][7])
        ...
        print "{:+7.3f}".format(x_new[:,0][7]*180/np.pi),",","{:+7.3f}".format(roll*180/np.pi),",","{:+7.3f}".format(tau_roll)
