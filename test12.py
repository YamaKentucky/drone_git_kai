...
yawrate_max     = 45 *np.pi/180 #rad/sec
...
#########################################################################################
    ...
    e_roll  = roll  - x_new[:,0][6]
    e_pitch = pitch - x_new[:,0][7]

#    print e_roll, e_pitch

    e_roll_dot =-(m9g_low[1]-bias_gyro_y)#(e_roll  - e_roll_old)  / del_t
    e_pitch_dot= (m9g_low[0]-bias_gyro_x)#(e_pitch - e_pitch_old) / del_t
