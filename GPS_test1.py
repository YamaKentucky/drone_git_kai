...
RR = np.diag([0.5,0.5,0.5,0.02,0.02,0.02])
...
anchor1 = np.array([-5,  5,0],dtype=float)
anchor2 = np.array([ 5,  5,0],dtype=float)
anchor3 = np.array([ 5, -5,0],dtype=float)
...
def compute():
    ...
    while 1:
        ...
        d1 = 0#int(DD[0])*0.01*0.8718 - 0.1834
        d2 = 10#int(DD[1])*0.01*0.8587 - 0.1882
        d3 = 10#int(DD[2])*0.01*0.8821 - 0.1896
...
######################################################################################### 
    ...
    print "{:+7.3f}".format(x_new[:,0][0]),",","{:+7.3f}".format(x_new[:,0][2])
