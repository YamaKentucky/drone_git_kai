...
while True:
    ...
    SS=x_old[5]+c_the*c_phi*acc[2]*del_t+g*del_t
    DD= SS*del_t+DD_old
    PP= SS*del_t
    DD_old = DD
########################################################################################
...
#    print  "{:+7.3f}".format(x_new[:,0][6]*180/np.pi),",","{:+7.3f}".format(x_new[:,0][7]*180/np.pi),",","{:+7.3f}".format(x_new[:,0][8]*180/np.pi)
    print "{:+7.3f}".format(m9g_low[1]),",","{:+7.3f}".format(-m9g_low[0]),",","{:+7.3f}".format(m9g_low[2])
#    print "{:+7.3f}".format(-m9a_low[1]),",","{:+7.3f}".format(m9a_low[0]),",","{:+7.3f}".format(-m9a_low[2])
