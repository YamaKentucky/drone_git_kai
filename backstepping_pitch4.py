...
#########################################################################################
    ...
    pitch = (float(rcin.read(1))-1514) * pitch_max_angle / 410#+11*np.pi/180
...
#    print "{:+7.3f}".format(x_new[:,0][6]*180/np.pi),",","{:+7.3f}".format(x_new[:,0][7]*180/np.pi),",","{:+7.3f}".format(x_new[:,0][8]*180/np.pi),",","{:+7.3f}".format(pitch*180/np.pi)
    ...
    if throt > 10:
        ...
        tau_pitch = 1000 * 1000 * I_x * ((1+ramda7+c[6]*c[7])*(pitch-x_new[:,0][6])+(c[6]+c[7])*(-omega1)+c[7]*ramda7*e_7-a_1*omega2*omega3)+1000*1000*0.045*0.13*9.81*np.sin(x_new[:,0][6])
        
        tau_roll = 0#1000 * 1000 * I_y * ((1+ramda9+c[8]*c[9])*(roll-x_new[:,0][7])+(c[8]+c[9])*(-omega2)+c[9]*ramda9*e_9-a_2*omega1*omega3)
        #print (roll - x_new[:,0][7])*180/np.pi
        tau_yaw = 0#1000 * 1000 * I_z * ((1+ramda11+c[10]*c[11])*(yaw-x_new[:,0][8])+(c[10]+c[11])*(-omega3)+c[11]*ramda11*e_11-a_3*omega1*omega2)
        ...
        print "{:+7.3f}".format(x_new[:,0][6]*180/np.pi),",","{:+7.3f}".format(pitch*180/np.pi),",","{:+7.3f}".format(tau_pitch)
